    ...
    <section class="inner-banner py-5">
        <div class="w3l-breadcrumb py-lg-5">
            <div class="container pt-4 pb-sm-4">
                <h4 class="inner-text-title font-weight-bold pt-sm-5 pt-4">Donasi</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.php">Home</a></li>
                    <li class="active"><i class="fas fa-angle-right mx-2"></i>Donasi</li>
                </ul>
            </div>
        </div>
        <div class="shape">
    ...
    <!-- //inner banner -->
     ...
     <section class="w3l-text-6 py-5">
        <div class="container pb-md-5 pb-4">
         <h2 style="text-align:center" class="title-style">Donasi Alumni</h2>
         <br>
         <br>
