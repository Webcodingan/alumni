...
-->
<?php include 'admin/backend/config.php' ?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <section class="inner-banner py-5">
        <div class="w3l-breadcrumb py-lg-5">
            <div class="container pt-4 pb-sm-4">
                <h4 class="inner-text-title font-weight-bold pt-sm-5 pt-4">Cari Alumni</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.php">Home</a></li>
                    <li class="active"><i class="fas fa-angle-right mx-2"></i>Cari alumni</li>
                </ul>
            </div>
        </div>
        <div class="shape">
    ...
    <!-- //inner banner -->
        ...
        <section class="inner-page mt-5">
            <div class="container">
                 <h2 style="text-align:center" class="title-style">Data Alumni</h2> 
                 <br>
